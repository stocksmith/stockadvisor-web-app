...
func (o *GetStocksQueryStockURL) WithBasePath(bp string) *GetStocksQueryStockURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetStocksQueryStockURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetStocksQueryStockURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetStocksQueryStockURL")
	}
